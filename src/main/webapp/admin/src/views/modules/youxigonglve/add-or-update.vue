          ...
          <el-form-item class="input" v-if="ruleForm.fabushijian" label="发布时间" prop="fabushijian">
              <el-input v-model="ruleForm.fabushijian" 
                placeholder="发布时间" readonly></el-input>
                                                                                                                                              ...
                                                                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="游戏攻略" prop="youxigonglve">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.youxigonglve" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.youxigonglve" label="游戏攻略" prop="youxigonglve">
                    <span v-html="ruleForm.youxigonglve"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='youxigonglve'){
            this.ruleForm.youxigonglve = obj[o];
            continue;
          }
                    if(o=='fabushijian'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `youxigonglve/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.youxigonglveCrossAddOrUpdateFlag = false;
                  this.parent.search();
