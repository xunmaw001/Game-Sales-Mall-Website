          ...
          <el-form-item class="input" label="游戏名称" prop="youximingcheng">
              <el-input v-model="ruleForm.youximingcheng" 
                placeholder="游戏名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="游戏分类" prop="youxifenlei">
          <el-input v-model="ruleForm.youxifenlei" 
              placeholder="游戏分类" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="游戏分类" prop="youxifenlei">
              <el-input v-model="ruleForm.youxifenlei" 
                placeholder="游戏分类" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="游戏补丁" prop="youxibuding">
          <file-upload
          tip="点击上传游戏补丁"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.youxibuding?ruleForm.youxibuding:''"
          @change="youxibudingUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.youxibuding" label="游戏补丁" prop="youxibuding">
            <el-button type="text" size="small" @click="download(ruleForm.youxibuding)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                                                  <el-col :span="24">  
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='youxibuding'){
            this.ruleForm.youxibuding = obj[o];
            continue;
          }
                    if(o=='xiangqing'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `youxibuding/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.youxibudingCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                ...
                                                youxibudingUploadChange(fileUrls) {
                this.ruleForm.youxibuding = fileUrls;
				this.addEditUploadStyleChange()
            },
